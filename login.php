    ...
    while($d=mysql_fetch_array($res))
        ...
        <tbody>
            <tr>
                ...
                <td width='10' height='10' ><input title=".'Редактировать'." value='Редактирование'></td>
        ...
        <div class="box4">
            ...
            <div class="rightwin">
                <form action="loginuser.php" method="post">
                    ...
                    echo"<a class='silk' href='exit.php'> <p>Exit</p> </a>";

                    if($law==1){
                    echo"<a class='silk' onclick=go_download()> <p>Загрузка(Админ)</p> </a>";}
                    echo"</div>";
                    ?>
